...
type BlogProps = {
  onSubmit: (
    value: BlogCreate,
    helpers: FormikHelpers<BlogCreate>
  ) => Promise<boolean>;
  submitting: boolean;
};

const CreateBlogForm = ({ onSubmit, submitting }: BlogProps) => {
                ...
                >
                  <Grid item alignSelf="flex-start" sx={{ flexGrow: 1 }}>
                    ...
                    >
                      ...
                      {Boolean(formik.errors.selection) && (
                        <FormHelperText>
                ...
                >
                  ...
                  <Grid item alignSelf="flex-start" sx={{ flexGrow: 1 }}>
                    ...
                    >
                      ...
                      {Boolean(formik.errors.tune_level) && (
                        <FormHelperText>
                          {formik.errors.tune_level}
                        </FormHelperText>
                      )}
                    </FormControl>
                  </Grid>
